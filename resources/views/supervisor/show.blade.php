            ...
            <div class="flex items-center gap-4">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" x-cloak x-transition
                        class="absolute right-0 mt-2 w-52 bg-gray-800 border border-gray-700 rounded-lg shadow-xl z-50 overflow-hidden">
                        <a href="{{ route('supervisor.export.pdf', [$access->uuid, 'month' => $currentMonth]) }}"
